    ...
    <div className="min-h-screen">
      ...
      <section className="section-hero">
        <div className="container-sm">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-body-primary leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-heading-primary mb-6">My Journey</h2>
              <div className="space-y-4 text-body-primary leading-relaxed">
                <p>
            ...
            <div className="card-project">
              <h3 className="text-2xl font-bold text-heading-primary mb-6">Quick Facts</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  <span className="text-body-secondary mr-3">☕</span>
                  <div>
                    <strong className="text-heading-primary">Favorite Coffee:</strong>
                    <span className="text-body-primary">Traditional Arabic coffee as well as classic Brazilian coffee.</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-body-secondary mr-3">🌍</span>
                  <div>
                    <strong className="text-heading-primary">Languages:</strong>
                    <span className="text-body-primary">Arabic (Native), English (proficient)</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-body-secondary mr-3">📚</span>
                  <div>
                    <strong className="text-heading-primary">Philosophy:</strong>
                    <span className="text-body-primary">&quot;Good work takes time&quot;</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-body-secondary mr-3">🎯</span>
                  <div>
                    <strong className="text-heading-primary">Mission:</strong>
                    <span className="text-body-primary">Building technology that bridges cultures and solves real problems, to develop the nation to lead the world.</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-md">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-heading-primary mb-4">Quality & Craftsmanship</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-heading-primary mb-4">Collaboration & Hospitality</h3>
              <p className="text-body-primary leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-heading-primary mb-4">Continuous Learning</h3>
              <p className="text-body-primary leading-relaxed">
          ...
          <div className="space-y-8">
            <div className="card-project">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h3 className="text-xl font-bold text-heading-primary">Data Scientist & AI Engineer</h3>
                <span className="text-body-secondary font-medium">2023 - Present</span>
              </div>
              <p className="text-body-primary leading-relaxed">
            ...
            <div className="card-project">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h3 className="text-xl font-bold text-heading-primary">Senior Information Systems Student</h3>
                <span className="text-body-secondary font-medium">2022 - 2023</span>
              </div>
              <p className="text-body-primary leading-relaxed">
            ...
            <div className="card-project">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h3 className="text-xl font-bold text-heading-primary">Information Systems Student</h3>
                <span className="text-body-secondary font-medium">2020 - 2022</span>
              </div>
              <p className="text-body-primary leading-relaxed">
      ...
      <section className="section-standard">
        <div className="container-sm text-center">
          <h2 className="text-3xl font-bold text-heading-primary mb-6 font-amiri">
            Let&apos;s Connect | لنتواصل
          </h2>
          <p className="text-body-primary mb-8 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a 
              href="mailto:naifsalehajeeb@gmail.com" 
              className="card-interactive inline-block px-6 py-3 text-heading-primary hover:bg-amber-100 dark:hover:bg-amber-800/50 transition-colors"
              title="Click to send email"
            >
              <div className="flex flex-col items-center gap-1">
                <span className="text-sm font-medium">📧 Get In Touch</span>
                <span className="text-xs text-body-secondary font-mono">naifsalehajeeb@gmail.com</span>
              </div>
            </a>
          </div>
        </div>
      ...
      <footer className="bg-amber-900/10 dark:bg-amber-900/20 py-12">
        <div className="container-sm text-center">
          <p className="text-body-primary font-amiri text-lg mb-2">
