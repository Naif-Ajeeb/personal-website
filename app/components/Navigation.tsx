    ...
    <nav className="backdrop-blur-md bg-white/30 dark:bg-amber-900/30 border-b border-amber-200 dark:border-amber-700 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold text-amber-900 dark:text-amber-200 hover:text-amber-800 dark:hover:text-amber-300 transition-colors">
            Portfolio
          </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="flex gap-6">
              <Link 
                href="/" 
                className={`text-amber-800 dark:text-amber-300 hover:text-amber-900 dark:hover:text-amber-200 transition-colors ${currentPage === 'home' ? 'font-semibold' : ''}`}
              >
                Home
              </Link>
              <Link 
                href="/about" 
                className={`text-amber-800 dark:text-amber-300 hover:text-amber-900 dark:hover:text-amber-200 transition-colors ${currentPage === 'about' ? 'font-semibold' : ''}`}
              >
                About
              </Link>
            </div>
